...
const LaunchPage = () => {
  ...
  return (
    <StyledWrapper>
      <div className="card" onClick={launchHandle}>
        <img
        ...
        <div className="icons">
            <a className="instagram"><svg></svg></a>
            <a className="x"><svg></svg></a>
            <a className="discord"><svg></svg></a>
        </div>
        <img src="./images/man.png" className=""/>
        {/* <LaunchButton /> */}
        <Earth />
      </div>
    </StyledWrapper>
